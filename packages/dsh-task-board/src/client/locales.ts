...
export const zh = {
  ...
  'board.hostError.notMounted': '任务看板的后台接口没有挂载，重启 DSH 服务后再试',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'board.hostError.notMounted': 'The task board Host API is not mounted; restart the DSH service and try again',
